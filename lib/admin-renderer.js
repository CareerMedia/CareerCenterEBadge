  ...
  const rows = entries.length
    ? entries
        ...
        <tr>
          ...
          <td>${escapeHtml(row.reason || row.errorMessage || '')}</td>
        </tr>`
        )
        .join('')
  ...
  const body = `
    <section class="admin-header">
      <div>
        ...
        <p>Each row is one attempt when a badge was issued (single issue, public generator, or bulk). Skipped rows explain why nothing was sent (for example disabled, missing API key, or invalid recipient).</p>
      </div>
    </section>
    <section class="admin-panel">
      <div class="table-wrap">
