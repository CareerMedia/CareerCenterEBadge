  ...
  const body = `
    ...
    <section class="admin-panel">
      <form method="post" action="/admin/email/save" class="admin-form admin-form--stacked" id="emailAwardSettingsForm">
        ...
        <textarea name="emailAwardTemplatesJson" id="emailAwardTemplatesJson" class="email-award-templates-json" aria-hidden="true" tabindex="-1">${escapeHtml(
          JSON.stringify(awardTemplates, null, 2)
        )}</textarea>
        ...
        <div class="inline-actions">
          <button type="submit" name="saveMode" value="templates_only" class="button button--ghost">Save template changes</button>
          <button type="submit" name="saveMode" value="full">Save all email settings</button>
        </div>
