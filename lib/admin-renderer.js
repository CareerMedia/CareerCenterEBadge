  ...
  <body>
    <div class="admin-shell">
      <aside class="admin-sidebar">
        <div>
          <p class="admin-sidebar__eyebrow">Private admin</p>
          <h1>Badge issuer</h1>
          <p class="admin-sidebar__copy">Create public badge pages, export URLs, update templates, and manage certificate placement settings.</p>
        </div>
...
<html lang="en">
  ...
  <body class="admin-login-page">
    <main class="admin-login-card">
      <p class="admin-sidebar__eyebrow">Private admin</p>
      <h1>Career Center badge dashboard</h1>
      <p>Sign in to issue badges, generate public verification pages, and manage certificate coordinates.</p>
  ...
  const body = `
    <section class="admin-header">
      ...
      <div class="inline-actions">
        ...
        <a class="button button--ghost" href="/generator/" target="_blank" rel="noreferrer">Open generator page</a>
      ...
      <form method="post" action="/admin/issue" class="admin-form">
        <div class="form-grid form-grid--two">
          ...
          <label>
            ...
            <input type="text" id="badgeImage" name="badgeImage" value="assets/badges/career-explorer-badge.svg" required />
          </label>
          <label>
  ...
  const rows = templates
    .map(
      ...
      <tr>
        ...
        <td>${escapeHtml(template.badgeImage || '')}</td>
        <td>
          <div class="inline-actions">
      ...
      <form method="post" action="/admin/templates/save" class="admin-form">
        <div class="form-grid form-grid--two">
          <label>
            ...
            <input type="text" name="id" value="${escapeAttribute(current.id)}" required placeholder="career-explorer" />
          </label>
          <label>
            <span>Badge title</span>
