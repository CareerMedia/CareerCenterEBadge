...
function renderTemplatesPage({ templates, editTemplate = null, notice = '', siteConfig, certificateTemplate }) {
  ...
  const rows = templates
    .map((template) => {
      const widgetCode = buildWidgetEmbedCode((siteConfig && siteConfig.publicSiteUrl) || '', template.id);
      return `
      <tr>
        <td>
  ...
  const widgetCode = buildWidgetEmbedCode((siteConfig && siteConfig.publicSiteUrl) || '', current.id || 'badge-template');
      ...
      <form method="post" action="/admin/templates/save" class="admin-form admin-form--stacked" id="badgeTemplateForm">
        ...
        <section class="template-config-shell">
          <div class="template-config-shell__header">
            ...
            <label class="checkbox-inline"><input type="checkbox" name="certificateTemplateOverrideEnabled" id="certificateTemplateOverrideEnabled" ${current.certificateTemplateOverrideEnabled ? 'checked' : ''} /> Use template-specific certificate coordinates</label>
          </div>
          <div class="coordinate-editor-grid">
            <div class="certificate-coordinate-preview" id="certificateCoordinatePreview">
              ...
              <button type="button" class="coordinate-dot coordinate-dot--name" data-coordinate-target="name"></button>
              <button type="button" class="coordinate-dot coordinate-dot--date" data-coordinate-target="date"></button>
            </div>
            <div class="form-grid form-grid--two">
              ...
              <label><span>Name font size</span><input type="number" name="templateNameFontSize" value="${escapeAttribute(effectiveTemplateCertificate.name.fontSize)}" /></label>
              ...
              <label><span>Date font size</span><input type="number" name="templateDateFontSize" value="${escapeAttribute(effectiveTemplateCertificate.date.fontSize)}" /></label>
