          ...
          <article class="panel panel--surface panel--issuer-statement">
            ...
            <div class="email-signature-block">
              ...
              <div class="email-signature-actions">
                <button type="button" class="button-secondary" data-copy-rich-html="${escapeAttribute(emailSignatureHtml)}" data-copy-text="${escapeAttribute(emailSignatureText)}">Copy email signature</button>
