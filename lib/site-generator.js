          ...
          <article class="panel panel--surface panel--issuer-statement">
            ...
            <div class="email-signature-block">
              <div class="email-signature-block__copy">
                ...
                <p>Copy a compact HTML snippet that links directly to this verification page and uses the hosted badge image.</p>
              </div>
              <div class="email-signature-preview">
                <a class="email-signature-preview__chip" href="${escapeAttribute(badge.publicUrl)}" target="_blank" rel="noreferrer">
                  ...
                  <span class="email-signature-preview__text">
                    ...
                    <small>Links to this verified credential</small>
                  </span>
                </a>
              </div>
              <div class="form-actions">
                <button type="button" class="button-secondary" data-copy-text="${escapeAttribute(emailSignatureHtml)}">Copy email signature HTML</button>
              </div>
            </div>
          </article>
        </div>
