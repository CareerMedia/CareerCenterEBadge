          ...
          <article class="panel panel--surface panel--issuer-statement">
            ...
            <div class="email-signature-block">
              ...
              <div class="email-signature-preview email-signature-preview--surface">
                <div class="email-signature-copy-root" id="emailSignatureCopyRoot">${emailSignatureHtml}</div>
              </div>
              <div class="email-signature-actions">
                <button type="button" class="button-secondary" data-copy-node-id="emailSignatureCopyRoot" data-copy-text="${escapeAttribute(emailSignatureText)}">Copy email signature</button>
                <p class="email-signature-help">Click copy, then paste directly into your Gmail or Outlook signature editor.</p>
              </div>
            </div>
          </article>
        </div>
