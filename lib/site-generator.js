...
function renderGeneratorPage(siteConfig, templates, certificateTemplate, options = {}) {
  ...
  const inner = `
      ...
      <section class="${widgetMode ? 'widget-section' : 'page-section'}">
        <div class="${widgetMode ? '' : 'wrap '}generator-layout${widgetMode ? ' generator-layout--widget' : ''}">
        ...
        <div class="wrap badge-detail-grid badge-detail-grid--rich">
          <article class="panel panel--surface panel--credential-fact">
            ...
            <dl class="detail-list">
              ...
              <div><dt>Verification hash</dt><dd><code>${escapeHtml(badge.verificationHash || '')}</code></dd></div>
            </dl>
          </article>
          ...
          <article class="panel panel--surface panel--verification">
            ...
            <dl class="detail-list detail-list--stacked">
              ...
              <div><dt>Issuer registry</dt><dd>${trust.issuerRegistryUrl ? `<a href="${escapeAttribute(trust.issuerRegistryUrl)}" target="_blank" rel="noreferrer">${escapeHtml(trust.issuerRegistryUrl)}</a>` : 'Not configured'}</dd></div>
